...
for idx, r in enumerate(r_grid[:-1]):
    ...
    def CASE2_bottom_left_corner(Schnittpunkte, boarders, Maximum_at_lower_x, r):
        
        if Schnittpunkte[0] == 1 and Schnittpunkte[2] == 1:
            I_max = Antiderivative(borders[0], Maximum_at_lower_x ,r)
            Kasten_max = (Maximum_at_lower_x-borders[0])*borders[2]
            Area = (I_max - Kasten_max)
    ...
    for i in coordinates:
        ...
        if x>=0 and y>=0:
            ...
            Area = CASE1_whole_pixel((Schnittpunkte_max)+(Schnittpunkte_min), x, y, borders, r_min, r_max )
            ...
            Area_r_max = CASE2_bottom_left_corner(Schnittpunkte_max, boarders, x_lower_max, r_max)
            Area_r_min = CASE2_bottom_left_corner(Schnittpunkte_min, boarders, x_lower_min, r_min)
            
            Area = 1 - (Area_r_max - Area_r_min)
